...
<p>After viewing all of the information contained in this tutorial, users should be able to:</p>
    ...
    <li>Know where to find important information about how a patient is doing while hospitalized in CCU</li>
<br>
<p>To use this tutorial, click anywhere on the page to see the front page of the CCU Green Sheet. Click on different areas of the treatment sheet to find more details about what information is found in that section and tips for successfully setting up and reading the treatment sheet.</p>
<p>To flip pages, click the forward or back arrows in the upper right of the website. Then, click on different areas of the treatment sheet to find more details about that section.</p>
`

const weightTracking = `
<h1>Weight Tracking</h1>
<p>Every patient in CCU should be weighed at least twice daily with their morning and evening TPR.</p>
<ul>
    <li>The AM and PM weights are recorded here on the front page of the CCU Treatment Sheet</li>
    <li>For easier weight tracking, the weight at patient intake is also recorded and copied to each new treatment sheet.</li>
    <li>If more frequent weight monitoring is needed, "weigh" is added as a <a href="./page2.html?x=300&y=200">line in Therapeutics</a></li>
</ul>
`
...
<p>The working problem list section is a very important section of the treatment sheet. This section should be updated as often as needed to ensure the critical care team - the resident/faculty and nurses - have the most up to date information about what the patient is hospitalized for.</p>
<ul>
    ...
    <li>In addition, each morning, the working problem list should be evaluated when the new treatment sheet is created and the problem list refined - lumping problems together when needed, adding new problems if they arise and resolving old problems that are no longer active.</li>
</ul>
`

const foodWater = `
<h1>Food/Water Prescription Information</h1>
<p>This section contains information about food and water orders for the patient.</p>
<ul>
    <li>Each patient should have diet orders including a specific food type, amount and frequency. Make sure to ask owners about the patient's at home diet or food allergies on admission or on transfer if that information has yet to be collected.</li>
...
<br>
<p>Information about exactly when to offer food/water and the <a href="./page2.html?x=200&y=250">patient's food and water intake</a> is found in the flow section of the treatment sheet.
`

const infusions = `
<h1>Infusions</h1>
<p>This section contains information about any fluids or liquids that are running continuously into the patient. Examples of infusions include:</p>
<ul>
...
<p>The front of the treatment sheet contains the information about the infusion prescription, such as the</p>
<ul>
...
<p>The name of the infusion is then transcribed on the center page in the flow section of the treatment sheet. The flow section is where infusion rates are tracked. <a href="./page2.html?x=200&y=300">Click Here to See</a></p>
</ul>
`

const catheters = `
<h1>Catheters/Tubes</h1>
<p>In this section, information on what type and size of catheter is placed is recorded. It is also important to record when these catheters are removed in this section. Different catheter types that should be included in this section include:</p>
<ul>
...
<h1>Code Status</h1>
<ul>
    <li>Every patient hospitalized in CCU needs to have a code status so that the CCU team knows the owner's wishes should a patient arrest.</li>
...
const warnings = `
<h1>Warnings</h1>
<p>This is an open section to include important pieces of information about the patient. Warnings may include:</p>
<ul>
...
<p>This section should be filled out so that the CCU technicians know how to proceed if a patient's catheter is no longer functional.</p>
<ul>
    <li>Please try to discuss this ahead of time - if your patient is no longer on IV medications and is likely to go home the same day, they may not need the IV catheter replaced.</li> 
    <li>If the patient is staying additional nights in CCU and has a code status of open or closed, it is recommended they have a patent IV catheter even if they are not receiving IV medications.</li>
</ul>
`

const procedures = `
<h1>Procedures Performed</h1>
<p>This section should be started on the day of admission and then updated at least daily with the major diagnostics and treatments provided to the patient.</p>
<ul>
